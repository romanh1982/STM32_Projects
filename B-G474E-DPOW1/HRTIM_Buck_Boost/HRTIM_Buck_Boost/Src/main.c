...
int main(void)
{
  ...
  MX_USART3_UART_Init();
  /* USER CODE BEGIN 2 */
  RetargetInit(&huart3);    // if you move printf retargeting into retarget.c
  APP_Init();
  /* USER CODE END 2 */
...
static void MX_HRTIM1_Init(void)
{
  ...
  pTimeBaseCfg.RepetitionCounter = 31;
  ...
  pCompareCfg.CompareValue = BUCK_PWM_PERIOD+1;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : BUCKBOOST_USBPD_EN_Pin */
  ...
  /*Configure GPIO pin : ADC1_IN1_PA0_I_IN_Pin */
  GPIO_InitStruct.Pin = ADC1_IN1_PA0_I_IN_Pin;
